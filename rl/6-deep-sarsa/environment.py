...
states = ['diff of x for obstacle and agent', 'diff of y for obstacle and agent', 'reward amount negative', 'diretction 0-3?',
          'diff of x for obstacle and agent', 'diff of y for obstacle and agent', 'reward amount negative', 'direction',
          'diff of x for obstacle and agent', 'diff of y for obstacle and agent', 'reward amount negative', 'direction',
          'diff of x for reward and agent', 'diff of y for reward and agent', 'reward amount positive']
...
class Env(tk.Tk):
    ...
    def get_state(self):
        ...
        printer = random.randint(0, 100) in range(10)
        for reward in self.rewards:

            reward_location = reward['state']
            if printer:
                print('rewx - agentx: {}'.format(reward_location[0] - agent_x))
                print('rewy - agenty: {}'.format(reward_location[1] - agent_y))
            ...
            if reward['reward'] < 0:
                ...
                if printer:
                    print('reward:{} dir:{}'.format(-1, reward['direction']))
            else:
                states.append(1)
                if printer:
                    print('reward: 1')
